          ...
          <div className=" STEP__top-bar">
            <div className="STEP__topBar-title">
              ...
              <div className="STEP__topbar-process-container">
                <div className="STEP__topBar-progress-2">
                  <div className="STEP__topBar-progress-value-2"></div>
                </div>
              </div>
